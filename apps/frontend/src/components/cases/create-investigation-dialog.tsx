...
export function CreateInvestigationDialog({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      handleApiError(error, "Failed to create investigation");
    } finally {
      ...
      <DialogContent className="sm:max-w-[425px]">
        <form onSubmit={handleSubmit}>
          <DialogHeader>
            ...
            <DialogDescription>
              Start a new investigation for this case. You can assign
              investigators after creation.
            </DialogDescription>
          </DialogHeader>
              ...
              <Select
                ...
                onValueChange={(value: string) =>
                  setFormData((prev) => ({
                    ...prev,
                    department: value
                      ? (value as InvestigationDepartment)
                      : undefined,
                  }))
                }
              >
