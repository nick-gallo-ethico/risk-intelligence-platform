...
describe("CaseDetailLayout", () => {
  ...
  it("renders all three panels", () => {
    render(
      <CaseDetailLayout caseData={mockCase} isLoading={false} error={null} />,
    );
  ...
  it("displays AI summary when available", () => {
    ...
    const aiSummaryTexts = screen.getAllByText(
  ...
  it("renders error state when error is provided", () => {
    ...
    expect(
      screen.getByText("Case not found. It may have been deleted."),
    ).toBeInTheDocument();
    expect(
  ...
  it("renders panel toggle buttons for mobile view", () => {
    ...
    const propertiesButtons = screen.getAllByRole("button", {
      name: /properties/i,
    });
