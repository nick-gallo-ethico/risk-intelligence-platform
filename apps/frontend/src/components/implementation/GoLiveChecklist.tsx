    ...
    <div className="space-y-6">
            ...
            return (
              <div
                ...
                className={cn(
                  ...
                  isPassed ? "bg-green-50/50 dark:bg-green-900/10" : "",
                )}
              >
                {isPassed ? (
                  <CheckCircle className="h-5 w-5 text-green-500 flex-shrink-0 mt-0.5" />
                ) : (
                  <XCircle className="h-5 w-5 text-gray-300 dark:text-gray-600 flex-shrink-0 mt-0.5" />
                )}
      ...
      <div className="bg-card border rounded-lg shadow-sm p-6">
        ...
        <div className="relative">
          ...
          {!status.isRecommendedMet && (
            <p className="mt-4 text-sm text-yellow-700 bg-yellow-50 p-3 rounded-lg border border-yellow-200 dark:bg-yellow-900/20 dark:text-yellow-300 dark:border-yellow-800">
                  ...
                  <div className="space-y-2">
                    <label className="flex items-start gap-2 text-sm cursor-pointer">
                      ...
                      <span className="text-muted-foreground">
                        I acknowledge the readiness score is below the
                        recommended threshold of {status.recommendedScore}%
                      </span>
                    </label>
                    <label className="flex items-start gap-2 text-sm cursor-pointer">
                      <input
                        ...
                        onChange={() =>
                          handleRiskToggle("accept_responsibility")
                        }
                        className="mt-0.5 rounded border-border"
                      />
                      <span className="text-muted-foreground">
      ...
      {status.hasSignoff && (
        <div className="bg-green-50 border border-green-300 rounded-lg p-4 flex items-center gap-3 dark:bg-green-900/20 dark:border-green-800">
