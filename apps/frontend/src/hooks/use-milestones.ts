...
export function useCreateMilestone() {
  ...
  return useMutation({
    mutationFn: async (dto: CreateMilestoneDto) => {
      const response = await api.post<MilestoneResponseDto>("/projects", dto);
      return response.data;
    },
    onSuccess: () => {
...
export function useAddMilestoneItem() {
  ...
  return useMutation({
    mutationFn: async ({
      ...
      const response = await api.post(`/projects/${milestoneId}/items`, dto);
      return response.data;
    },
  ...
  return useMutation({
    mutationFn: async ({
      ...
      const response = await api.patch(
        `/projects/${milestoneId}/items/${itemId}`,
        dto,
      );
      return response.data;
    },
...
export function useDeleteMilestoneItem() {
  ...
  return useMutation({
    mutationFn: async ({
      ...
      await api.delete(`/projects/${milestoneId}/items/${itemId}`);
    },
    onSuccess: (_, { milestoneId }) => {
      queryClient.invalidateQueries({
        queryKey: [MILESTONES_KEY, milestoneId],
