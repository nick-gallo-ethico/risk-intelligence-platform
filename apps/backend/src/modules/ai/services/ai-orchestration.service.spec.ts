...
import { AiOrchestrationService, UserContext, ChatInput } from './ai-orchestration.service';
...
describe('AiOrchestrationService', () => {
  ...
  const mockAgentRegistry = {
    ...
    listAgentTypes: jest.fn().mockReturnValue(['investigation', 'case', 'compliance-manager']),
  };
  ...
  describe('resolveAgentType (private method tested via processChat)', () => {
    ...
    it('should use compliance-manager for unknown entity types', async () => {
      ...
      mockAgentRegistry.getAgentTypeForEntity.mockReturnValueOnce('compliance-manager');
