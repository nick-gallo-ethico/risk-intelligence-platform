...
export class CreateRiuDto {
  ...
  @ApiPropertyOptional({ description: 'Access code for anonymous status checks' })
  @IsOptional()
  @IsString()
  anonymousAccessCode?: string;

  @ApiPropertyOptional({ description: 'Reporter name (encrypted if identified)' })
  @IsOptional()
  @IsString()
  @MaxLength(255)
  reporterName?: string;

  @ApiPropertyOptional({ description: 'Reporter email (encrypted if identified)' })
  @IsOptional()
  @IsString()
  @MaxLength(255)
  reporterEmail?: string;

  @ApiPropertyOptional({ description: 'Reporter phone (encrypted if identified)' })
  @IsOptional()
  @IsString()
  @MaxLength(50)
  ...
  // Campaign linkage
  @ApiPropertyOptional({ description: 'Campaign ID for disclosure/attestation responses' })
  @IsOptional()
  @IsUUID()
  campaignId?: string;
  ...
  @ApiPropertyOptional({ description: 'Whether this is immutable base data', default: false })
  @IsOptional()
  @IsBoolean()
  isBaseData?: boolean;
}
