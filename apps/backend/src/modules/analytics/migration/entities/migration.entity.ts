 ...
 */
export const NAVEX_FIELD_MAPPINGS: Record<
  string,
...
> = {
  ...
  due_date: {
    targetField: "dueDate",
    targetEntity: TargetEntityType.INVESTIGATION,
  },
 ...
 */
export const EQS_FIELD_MAPPINGS: Record<
  string,
  { targetField: string; targetEntity: TargetEntityType }
> = {
  report_id: {
 ...
 */
export const LEGACY_ETHICO_FIELD_MAPPINGS: Record<
  string,
  { targetField: string; targetEntity: TargetEntityType }
> = {
  case_num: {
...
export const TRANSFORM_DESCRIPTIONS: Record<TransformFunction, string> = {
  ...
  [TransformFunction.PARSE_BOOLEAN]:
    "Parse as boolean (yes/no, true/false, 1/0)",
