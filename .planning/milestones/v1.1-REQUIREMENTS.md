# Requirements Archive: v1.1 Code Review Remediation
...
| Feature                                  | Reason                                                           |
| ---------------------------------------- | ---------------------------------------------------------------- |
| New feature development                  | Remediation milestone — hardening only                           |
| Full 80% test coverage                   | Foundation phase targets auth + core services; remaining in v1.2 |
| Complete refactor of all 133 bare throws | Top 10 files (100 instances) first; remaining 33 in v1.2         |
| Y.js real-time collaboration security    | Deferred to v2                                                   |
