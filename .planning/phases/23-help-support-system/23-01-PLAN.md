...
must_haves:
  truths:
    ...
    - "Global articles (orgId=null) are visible to all tenants AND tenant-specific articles only return for their organization"
  artifacts:
...
- Inject NotificationService via constructor: `import { NotificationService } from '../../notifications/services/notification.service';`
...
- NestJS module importing PrismaModule and NotificationsModule (to make NotificationService injectable in TicketListener): `import { NotificationsModule } from '../notifications/notifications.module';`
- imports array: `[PrismaModule, NotificationsModule]`
