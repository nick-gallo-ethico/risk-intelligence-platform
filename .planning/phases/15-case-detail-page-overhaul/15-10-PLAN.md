...
must_haves:
  truths:
    - "AI can add notes to cases (not just investigations)"
    - "AI change-status action works for cases"
    - "AI actions appear in activity feed"
  artifacts:
...
2. AI can add notes to cases via the chat panel
3. AI can change case status via the chat panel
4. All AI actions appear in the case activity feed
